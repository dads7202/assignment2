...
## 🌟 Highlight
-   Almost all fine-tuning pre-trained CNN models are better than the original pre-trained models which trained on the ImageNet dataset.
...
- The performance models of almost all fine-tuning CNN are better than original pre-trained models which trained on the imageNet dataset (Our datasets doesn't exist on ImageNet dataset).
