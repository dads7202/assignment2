...
- The performance models of all fine-tuning CNN are better than original pre-trained models which trained on the imageNet dataset (Our datasets do not exist in the original pretrained model)
